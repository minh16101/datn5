...
public class BookingRoomEntity {
    ...
    public String priceBookingRoom;
    ...
    public BookingRoomEntity(String nameBookingRoom, int peopleBookingRoom, String priceBookingRoom, String notiBookingHotel, int isBookingRoom, int fkBookingRoom) {
