...
public class BookingCarEntity
{
    ...
    public BookingCarEntity(String nameBookingCar, String startPlaceBookingCar, String endPlaceBookingCar, String upPlaceBookingCar, String downPlaceBookingCar, int dayBookingCar, int monthBookingCar, int yearBookingCar, int numberSeatBookingCar) {
